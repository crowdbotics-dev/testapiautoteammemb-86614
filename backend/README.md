...
## Project Structure
    ...
    ├── testapiautoteammemb_86614  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_86614`
...
2. Clone this repo and `cd testapiautoteammemb_86614`
